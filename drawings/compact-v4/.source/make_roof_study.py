...
def sheet2(c):
 base(c,2,'First-floor stair and roof headroom','R12 / 14 SEP 2026 / PROPOSED FIRST-FLOOR STAIR 1:35 / DEVELOPED STAIR PROFILE 1:50 AT A3 / CONCEPTUAL RCC WAIST AND LANDING SLABS')
 ...
 v4.para(c,25,46,'Two rises of 3.00 m: GF to FF, then FF to roof. Each storey keeps 17 equal risers of 176.47 mm and 250 mm treads. R9 redistributed the ground-to-first risers (5 + 7 + 4-plus-arrival, was 2 + 7 + 8) but changed neither, and R10/R12 leave that geometry alone; first-to-roof keeps its original 9 + 8. Both storeys are drawn as one continuous RCC waist slab per flight with landing slabs at the turns. The waist top plane sits on the internal corners of the steps, one riser below the nosing line, and walking-line headroom on the flights is 2.26 m against the new soffit - still clear of the 2.20 m benchmark.',117,8,4.5)
 section(Plan(c,180,53,20))
 v4.para(c,180,36,'Developed paths: GF has a 5 + 7 + 4-plus-arrival riser turn (R9, was 2 + 7 + 8) and neither R10 nor R12 touches it; first-to-roof retains 9 + 8 unchanged, so the stair continues to the roof exactly as before. Each flight shows its slab depth and soffit, landing on the plinth, the landing slabs and the floor slabs. STAIR SHOWN AS CONCEPTUAL RCC WAIST-SLAB SYSTEM. FINAL WAIST-SLAB THICKNESS, LANDING BEAMS, SUPPORT CONDITIONS, REINFORCEMENT AND CONNECTIONS TO BE DESIGNED BY STRUCTURAL ENGINEER. 100 MM PARTITION WALLS ARE NOT TO BE ASSUMED LOAD-BEARING.',215,8,4.5)
