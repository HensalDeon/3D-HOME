...
def sheet2(c):
 ...
 v4.para(c,25,46,'Two rises of 3.00 m, each 17 risers of 176.47 mm and 250 mm treads. R9 redistributed the ground risers (5 + 7 + 4-plus-arrival); first-to-roof keeps 9 + 8. WALKING-LINE HEADROOM IS NOT UNIFORM AND BOTH GROUND FLIGHTS ARE UNDER THE 2.20 m BENCHMARK: west flight 1.73 m, upper return 2.09 m; first-to-roof 2.67 m and 2.40 m. R9 raised the west flight 0.53 m toward the parallel flight above; the 2.26 m once stated here was pre-R9. RESOLVE IN THE DESIGN.',117,8,4.5)
 section(Plan(c,180,53,20))
 v4.para(c,180,36,'Developed paths: GF has a 5 + 7 + 4-plus-arrival riser turn (R9, was 2 + 7 + 8) and neither R10, R12 nor R14 touches it; first-to-roof retains 9 + 8 unchanged, so the stair continues to the roof exactly as before. Each flight shows its slab depth and soffit, landing on the plinth, the landing slabs and the floor slabs. STAIR SHOWN AS CONCEPTUAL RCC WAIST-SLAB SYSTEM. FINAL WAIST-SLAB THICKNESS, LANDING BEAMS, SUPPORT CONDITIONS, REINFORCEMENT AND CONNECTIONS TO BE DESIGNED BY STRUCTURAL ENGINEER. 100 MM PARTITION WALLS ARE NOT TO BE ASSUMED LOAD-BEARING.',215,8,4.5)
