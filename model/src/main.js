...
function apply(){
 ...
 const titles={exterior:['THE COMPLETE PICTURE','Your home, from every angle.','6.07 × 9.77 m ground footprint · full roof access'],ground:['GROUND FLOOR / +0.45 M','A place for everyday life.','59.30 m² envelope · one bedroom with private ensuite'],first:['FIRST FLOOR / +3.45 M','Room to retreat. Space to connect.','58.51 m² envelope · two bedrooms, two ensuites'],roof:['ROOF TERRACE / +6.45 M','An open sky above your home.','9.02 m² stair enclosure · cap at +9.00 m']}[state.mode];
