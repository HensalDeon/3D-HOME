...
let currentSheet=1;
function showSheet(n){currentSheet=n;$('#sheet-image').src=assets.sheets[n-1];$('#sheet-image').alt=`Sheet ${n}: ${sheetTitles[n-1]}`;$('#sheet-caption').textContent=`Sheet ${String(n).padStart(2,'0')} / 11 · ${sheetTitles[n-1]} · Original plan sheet`;$$('#sheet-list button').forEach((b,i)=>b.classList.toggle('active',i===n-1));}
